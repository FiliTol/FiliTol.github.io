...
Nel novembre 2023 la Bank for International Settlements ha annunciato la creazione del <a href="https://www.bis.org/publ/othp80.htm" target="_blank">Progetto Tourbillon</a>, il quale propone un'implementazione di ecash chaumiano all'interno di un sistema a Central Bank Digital Currency (CBDC). Il progetto sembra garantire maggiore privacy negli scambi, mantenendo anonima l'identità del pagante ma conservando la possibilità di monitorare e tracciare le transazioni del ricevente ai fini fiscali, di antiriciclaggio ed anti-terrorismo.
